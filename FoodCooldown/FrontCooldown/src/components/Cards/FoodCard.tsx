...
export function FoodCard({ food }: IFoodCardProps): JSX.Element {
    ...
    return (
        <li className="bg-[#333333] p-0.5 rounded-xl shadow-lg border border-[#444444] hover:shadow-indigo-600 transition duration-300 flex flex-row items-center justify-between cursor-pointer w-full">
            {/* Um ícone de prato genérico apenas para enfeite */}
